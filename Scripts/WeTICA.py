...
parser.add_argument("-dist1", type=float, help="Merge distance cut-off (unitless) [Optional, default=0.5]",required=False, default=0.5)
parser.add_argument("-dist2", type=float, help="Warped distance cut-off (unitless) [Optional, default=0.75]",required=False, default=0.75)
